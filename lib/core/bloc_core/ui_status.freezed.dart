...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( String message)?  loadFailed,TResult Function( String? message)?  loadSuccess,required TResult orElse(),}) {final _that = this;
switch (_that) {
case UIInitial() when initial != null:
return initial();case UILoading() when loading != null:
return loading();case UILoadFailed() when loadFailed != null:
return loadFailed(_that.message);case UILoadSuccess() when loadSuccess != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( String message)  loadFailed,required TResult Function( String? message)  loadSuccess,}) {final _that = this;
switch (_that) {
case UIInitial():
return initial();case UILoading():
return loading();case UILoadFailed():
return loadFailed(_that.message);case UILoadSuccess():
return loadSuccess(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( String message)?  loadFailed,TResult? Function( String? message)?  loadSuccess,}) {final _that = this;
switch (_that) {
case UIInitial() when initial != null:
return initial();case UILoading() when loading != null:
return loading();case UILoadFailed() when loadFailed != null:
